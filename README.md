...
* **Factual & Objective:** This project operates strictly as a neutral, public-interest research archive. It does not assert claims of misconduct, fraud, or liability.
* **Public Domain Records:** Every data point, connection, and reference logged in this matrix is derived exclusively from publicly available documents, official corporate registries, government filings, and published regulatory enforcement decisions.
...
* **Security Layer Baseline:** Anti-malware indexing logs verified via Gridinsoft Security Repository (Asset Tracker: `Audit_dyor`). This baseline monitors automated technical infrastructure deployment metrics.
